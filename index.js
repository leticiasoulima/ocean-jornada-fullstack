...
const url = "mongodb+srv://admin:fDfCk6Fos7Qc9HMT@cluster0.p4hdryn.mongodb.net/";
const bancoDadosNome = "ocean_jornada_fullstack_novembro_22_leticia";
...
async function main() {
    ...
    app.get("/itens/:id", function(req, res) {
        ...
        // Realizamos um busca no banco de dados
    ...
    app.put("/itens/:id", async function(req, res) {
        ...
        // Atualizamos no novo item no bd
